...
05/09/21
Version 5
- Input type checker for short answers created
- Removed global variables
- Created ask ok cancel for empty score exports
"""
...
class Quiz:
    ...
    def open_help(self):
        ...
        get_help.help_text.configure(text="Click Start! to begin!\n\n"
                                          ...
                                          "All image sources acknowledged in Image Sources.txt",
                                     bg=background,
                                     justify=LEFT)
    ...
    def level(self):
        ...
        if self.level_number == 1:
            ...
            self.play_short_answer.bind('<Return>', self.check_answer_1)
