...
class Quiz:
    ...
    def next(self):
        global random_mode, country, keys, mode, others, answer, play_frame, play_next_button, play_button_1, play_button_2, play_button_3, play_button_4, level, play_question, play_feedback, play_label, play_short_answer, question, play_short_answer_button, image_1, image_2, image_3, image_4
        # Next question
        level += 1
