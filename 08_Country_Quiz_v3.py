...
03/09/21
Version 3
- Changed default score shown to last mode played
- Bound entry field to check answers by enter key and export field to export by enter key
- Added code to automatically tab through letters when valid input entered
- Ask ok cancel for existing file names when exporting
"""
...
class Export:
    ...
    def export_file(self, empty=''):
        ...
        if not accepted:
            ...
            if my_file.is_file():
                do_export = msgbox.askokcancel("This file already exists!", f"{self.filename} is an existing file.\n\nOverwrite file?", parent=self.export_box, icon="warning")
