...
class Export:
    def __init__(self):
        ...
        var_country = IntVar()
        var_random = IntVar()
        export_country_check = Checkbutton(export_frame,
                                           text="Country scores only",
                                           bg=background,
                                           font=("lucida console", "8"),
                                           variable=var_country,
                                           command=lambda: self.check_mode(export_country_check),
                                           activebackground=background)
        export_country_check.grid(row=5)
        export_random_check = Checkbutton(export_frame,
                                          text="Random scores only",
                                          bg=background,
                                          font=("lucida console", "8"),
                                          variable=var_random,
                                          command=lambda: self.check_mode(export_random_check),
                                          activebackground=background)
        ...
        final_export_button = Button(export_frame,
                                     ...
                                     activebackground='light goldenrod')
        final_export_button.grid(row=7, pady=5)
        ...
        export_dismiss_button = Button(export_frame,
                                       ...
                                       activebackground='light goldenrod')
        export_dismiss_button.grid(row=8, pady=20)
...
scores = [[10, "JJY", "New Zealand"], [9, "CSW", "South Korea"], [9, "JJY", "Japan"], [8, "SDW", "South Korea"], [4, "GCS", "France"], [4, "LJH", "Colombia"], [2, "DIN", "China"], [2, "DAN", "Netherlands"], [1, "ABD", "Jamaica"]]
